...
const Input: FC<InputProps> = ({
  ...
  let inputClasses = `h-11 w-full rounded-lg   px-4 py-2.5 text-sm  placeholder:text-gray-400 ${className}`;

  if (disabled) {
    inputClasses += ` text-gray-500 opacity-40 bg-gray-100 cursor-not-allowed  opacity-40`;
  } else if (error) {
